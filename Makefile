...
CPP = g++
CPPFLAGS = -g -std=c++11 -Wall -Werror -I$(C150LIB) -lssl -lcrypto
...
LDFLAGS = 
INCLUDES = $(C150LIB)c150dgmsocket.h $(C150LIB)c150nastydgmsocket.h $(C150LIB)c150network.h $(C150LIB)c150exceptions.h $(C150LIB)c150debug.h $(C150LIB)c150utility.h sharedfiledefs.h ClientFile.h ServerFile.h
...
fileserver: fileserver.cpp sharedfiledefs.cpp ServerFile.cpp $(C150AR) $(INCLUDES)
	$(CPP) -o fileserver  $(CPPFLAGS) ServerFile.cpp fileserver.cpp sharedfiledefs.cpp $(C150AR)

fileclient: fileclient.cpp sharedfiledefs.cpp ClientFile.cpp $(C150AR) $(INCLUDES)
	$(CPP) -o fileclient  $(CPPFLAGS) ClientFile.cpp fileclient.cpp sharedfiledefs.cpp $(C150AR)
#
# Build the sha1test
#
...
clean:
	 rm -f fileserver fileclient nastyfiletest sha1test makedatafile *.o 
